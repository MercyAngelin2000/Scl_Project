...
export class GeneralInfoComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.generalForm=this.fb.group({
      ...
      off_email:['',Validators.required],
      off_phone:['',Validators.required],
      ...
      cors_mobile:['',Validators.required],
      cors_email:['',Validators.required],
      prin_name:['',Validators.required],
      prin_phone:['',Validators.required],
      prin_email:['',Validators.required],
      prin_mobile:['',Validators.required],
      ...
      president_phone:['',Validators.required],
      president_email:['',Validators.required],
      ...
      ntt_tem_female:[''],
      untrained_per_male:[''],
      untrained_per_female:[''],
      untrained_tem_male:[''],
      untrained_tem_female:[''],
      lib_per_male:[''],
      lib_per_female:[''],
      lib_tem_male:[''],
      lib_tem_female:[''],
      ...
      art_tem_female:[''],
      counsellor_per_male:[''],
      counsellor_per_female:[''],
      counsellor_tem_male:[''],
      counsellor_tem_female:[''],
      lit_per_male:[''],
      lit_per_female:[''],
      lit_tem_male:[''],
      lit_tem_female:[''],
